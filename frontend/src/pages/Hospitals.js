                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {imagingOptions.map(option => (
                    <div
                      ...
                      className={`flex flex-col items-center justify-center p-3 rounded-lg cursor-pointer border-2 transition-colors ${filters.medicalImaging.includes(option.value)
