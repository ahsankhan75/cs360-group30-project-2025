  ...
  return (
    <header className="bg-white p-4 md:p-6 flex justify-start items-center">
      ...
      <nav className="flex space-x-6">
        <a href="/" className="hover:text-[#15aacf]">
          Home
        </a>
        <a href="/hospitals" className="hover:text-[#15aacf]">
          Find Hospitals
        </a>
        <a href="/requests" className="hover:text-[#15aacf]">
          Donations
        </a>
        <a href="/admin/requests" className="hover:text-[#15aacf]">
          Add Request
        </a>
